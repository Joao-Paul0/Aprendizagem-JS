...
const array1 = [12, 7, 33]
const array2 = ['coelho', 'águia', 'corvo']
const concatenar = concatenarArray(array1, array2)
...
const menuPrincipal = ['Pizza', 'Pastel', 'Shawarma']
const menuDeSobremesas = ['Sorvete', 'Gelatina', 'Torta de limão']
